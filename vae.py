...
class VAE(nn.Module):
    def __init__(self):
        ...
        self.fc4 = nn.Linear(400, 600)
        self.fc5 = nn.Linear(600, 784)
...
def loss_function(recon_x, x, mu, logvar):
    ...
    KLD = 0.5 * (-1 - logvar + mu.pow(2) + logvar.exp()).sum(axis = 1)
    # KLD = (recon_x * (recon_x/x).log())
    return recon_loss + 100*KLD.mean()
